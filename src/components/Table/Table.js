...
function Table() {
  ...
  const appendNewData = useCallback(function () {
    ...
    function getRndInteger(min = 200, max = 10000, floor = true) {
      ...
      if (floor) {
        ...
        rndInteger = rndInteger.slice(0, rndInteger.indexOf(".") + 7);
      ...
      // Truncate fee to 6 decimal places
      rndInteger = rndInteger.slice(0, rndInteger.indexOf(".") + 4);
      // Change fee from string to number
    ...
    const blockOutNumber = [
      16997816, 17007014, 16996680, 17114119, 16886422, 18883122,
